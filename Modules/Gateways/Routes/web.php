...
use Modules\Gateways\Http\Controllers\PlugnPayController;
use Modules\Gateways\Http\Controllers\OrangeMoneyController;
...
if ($is_published) {
    Route::group(['prefix' => 'payment'], function () {
        ...
        // Orange Money
        Route::group(['prefix' => 'orange-money', 'as' => 'orange-money.'], function () {
            Route::any('pay', [OrangeMoneyController::class, 'payment'])->name('pay');
            Route::any('callback', [OrangeMoneyController::class, 'callback'])->name('callback')
                ->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
        });
        ...
        //PlugnPay
        Route::group(['prefix' => 'plugnpay', 'as' => 'plugnpay.'], function () {
            Route::get('pay', [PlugnPayController::class, 'index'])->name('pay');
            Route::any('callback', [PlugnPayController::class, 'callback'])->name('callback')
                ->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);
        });
