...
@section('title', translate('messages.edit_ppob_transaction'))
    ...
    <div class="content container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">
                        ...
                        <span>{{ translate('messages.edit_ppob_transaction') }}</span>
                    </h1>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{ route('admin.ppob.transactions.update', $transaction->id) }}" method="post" id="transactionForm">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label">{{ translate('messages.ref_id') }}</label>
                                        <input type="text" class="form-control readonly-field" value="{{ $transaction->ref_id }}" disabled>
                                        <small class="text-muted">{{ translate('messages.ref_id_cannot_be_changed') }}</small>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="customer_no" class="form-control" 
                                               ...
                                               value="{{ old('customer_no', $transaction->customer_no) }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="buyer_sku_code" class="form-control" 
                                               ...
                                               value="{{ old('buyer_sku_code', $transaction->buyer_sku_code) }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" id="price" class="form-control" 
                                               ...
                                               value="{{ old('price', $transaction->price) }}" step="0.01" min="0" required onchange="calculateProfit()">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="original_price" id="original_price" class="form-control" 
                                               ...
                                               value="{{ old('original_price', $transaction->original_price ?? 0) }}" step="0.01" min="0" required onchange="calculateProfit()">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted mt-2 d-block">
                                            Current: {{ \App\CentralLogics\Helpers::format_currency($transaction->price - ($transaction->original_price ?? 0)) }}
                                        </small>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control" required>
                                            ...
                                            <option value="Pending" {{ old('status', $transaction->status) == 'Pending' ? 'selected' : '' }}>{{ translate('messages.pending') }}</option>
                                            <option value="Success" {{ old('status', $transaction->status) == 'Success' ? 'selected' : '' }}>{{ translate('messages.success') }}</option>
                                            <option value="Failed" {{ old('status', $transaction->status) == 'Failed' ? 'selected' : '' }}>{{ translate('messages.failed') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="buyer_last_saldo" class="form-control" 
                                               ...
                                               value="{{ old('buyer_last_saldo', $transaction->buyer_last_saldo) }}" step="0.01" min="0">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tele" class="form-control" 
                                               ...
                                               value="{{ old('tele', $transaction->tele) }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="message" class="form-control" rows="3" 
                                                  placeholder="{{ translate('messages.message') }}">{{ old('message', $transaction->message) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
